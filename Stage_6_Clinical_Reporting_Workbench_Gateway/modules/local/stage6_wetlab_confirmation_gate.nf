process STAGE6_WETLAB_CONFIRMATION_GATE {
    ...
    publishDir "${params.stage6_outdir}/audit_and_qc", mode: 'copy', overwrite: true, pattern: '*.wetlab_confirmation_pending_queue.json'
    publishDir "${params.stage6_outdir}/audit_and_qc", mode: 'copy', overwrite: true, pattern: '*.stage6_wetlab_confirmation.fragment.json'
